...
This repository implements the Overwolf overlay manager for Escape From Marathon:
...
For all images related to items, the app calls the Marathondev api to retrieve the name/icon link.
